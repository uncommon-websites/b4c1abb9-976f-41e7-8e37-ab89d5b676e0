    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-20">
            <h2 class="text-4xl md:text-5xl font-serif text-gray-900 leading-tight max-w-4xl">
                Just as ERPs digitized business records, <span class="font-semibold">Camu is now transforming fiscal receiving.</span>
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative">
                <div class="relative rounded-lg overflow-hidden shadow-2xl bg-gray-900 aspect-[4/3]">
                    <img 
                        src="/generated/image-a-wide-shot-of-a-modern-logistics-center-1768825546774-3.webp" 
                        alt="Logistics and fiscal operations" 
                    ...
                    <div class="absolute inset-0 flex items-center justify-center p-8">
                        <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
                            <div class="flex items-center gap-3 mb-4">
                                <div class="h-8 w-8 bg-black rounded flex items-center justify-center text-white">
                                    <Database size={16} />
                                </div>
                                <span class="font-medium text-gray-900">Fiscal Validation</span>
                            </div>
                            <div class="space-y-2">
                                <div class="h-2 bg-green-100 rounded w-3/4"></div>
                                <div class="h-2 bg-green-50 rounded w-1/2"></div>
                            </div>
            ...
            <div class="space-y-12">
                <h3 class="text-2xl font-serif text-gray-900">
                    A Modern Layer on Top of Your ERP <br/> Built for Compliance at Scale
                </h3>

                <div class="space-y-8">
                    {#each [
                        { id: '01', title: 'Capture all inbound notas fiscais', icon: Database },
                        { id: '02', title: 'Validate against 10M+ tax rules', icon: Search },
                        { id: '03', title: 'Automate ERP posting & correction', icon: Settings },
                        { id: '04', title: 'Centralize supplier collaboration', icon: FileText }
                    ] as feature}
